        ...
        Scenario 3: Password Field Masking
            Given I am on the login page
        ...
        Scenario 4: Login with Empty Username
            Given I am on the login page
        ...
        Scenario 5: Login with Empty Password
            Given I am on the login page
...
### Part 2: File Uploader
        ...
        Scenario 2: Attempt to Upload Without Selecting a File
            Given I am on the file uploader page
             When I do not select a file
              And I click on the "Upload" button
             Then I should see an error message or no file name should be displayed

        Scenario 3: Upload of a File with a Specific Format
            Given I am on the file uploader page
...
### Part 3: Missing Element Page
        ...
        Scenario 1: Handle Missing Element Gracefully
        ...
        Scenario 2: Interaction with a Dynamically Loaded Element
            Given I am on the missing element page
